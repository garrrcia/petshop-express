...
const petshop = {
    ...
    listarPets: () => {
        ...
        bancoDados.pets.forEach((pet) => {
            ...
            console.log(`O nome do pet é ${pet.nome}, ${pet.idade}, ${pet.tipo}, ${pet.raca}, ${(pet.vacinado ? 'vacinado' : 'não vacinado')}`);
...
//subir outros metodos dos github
